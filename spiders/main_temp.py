...
class AppSpider(scrapy.Spider):
    ...
    def parseAppDetails_v2(self,response):
        ...
        kvmap={'Seller':'app_seller', 'Size':'app_size', 'Category':'app_category_name', 'Price':'app_pricing', 'App Support':'app_support_site', 'Developer Website':'app_publisher_home_site', 'Privacy Policy':'app_privacy_policy', 'Copyright':'app_copyright', 'Age Rating':'app_rating'}                
